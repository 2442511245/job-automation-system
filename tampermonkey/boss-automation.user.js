 ...
 *
 * 【⚙️ 配置后端地址】
 *   安装后，将下方 CONFIG.API_BASE 修改为你的后端地址。
 *   如果后端不在本机运行，需要同时更新 @connect 声明。
 *
 *   例如：
 *     API_BASE: 'http://192.168.1.100:5000',  // 局域网其他机器
 *     API_BASE: 'http://your-server.com:5000', // 远程服务器
 *
 * 【使用说明】
 *   1. 确保 Flask 后端已启动
 *   2. 在仪表盘配置 API Key、候选人档案、简历等
...
(function () {
    ...
    // ============================================================
    //  ⚙️ 配置项 —— 请修改 API_BASE 为你的后端地址
    //  其他策略配置会在启动时从后端自动获取
    // ============================================================
    const CONFIG = {
        // ★ 后端地址：修改为你的 Flask 服务地址（末尾不要加 /）
